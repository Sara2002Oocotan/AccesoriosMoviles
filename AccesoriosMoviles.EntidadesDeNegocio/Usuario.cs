...
namespace AccesoriosMoviles.EntidadesDeNegocio
{
    public class Usuario
    {
        ...
        [StringLength(32, ErrorMessage = "Password debe estar entre 5 a 25 caracteres", MinimumLength = 5)]
        public string Password { get; set; }

        [Required(ErrorMessage = "Estatus es obligatorio")]
        public byte Estatus { get; set; }

        [Required(ErrorMessage = "Fecha registro")]
        ...
        [NotMapped]
        [Required(ErrorMessage = "Confrimar el password ")]
        [StringLength(32, ErrorMessage = "Password debe de estar entre 5 a 32 caracteres", MinimumLength = 5)]
        [DataType(DataType.Password)]
